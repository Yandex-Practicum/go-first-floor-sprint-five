...
func (w Walking) Calories() float64 {
	...
	return (CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(avgSpeed, 2)/(w.Weight/CmInM))*CaloriesSpeedHeightMultiplier*w.Training.Weight) * float64(w.Duration.Hours()) * MinInHours
}

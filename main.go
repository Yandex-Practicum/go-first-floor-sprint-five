...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	burnedCalories := CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift
	weight := r.Weight / MInKm
	return burnedCalories * weight * r.Duration.Hours() * MinInHours
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	info := InfoMessage{s.TrainingType,
		s.Duration,
		s.distance(),
		s.meanSpeed(),
		s.Calories()}

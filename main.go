...
// В ТЗ не было задачи переопределить distance() для плавания,
// но было бы странно переопределить скорость от других параметров,
// а расчет дистанции оставить.

// distance возвращает дистанцию, которую проплыл пользователь.
// Формула расчета:
// количество_пересечений_бассейна * длина_бассейна / м_в_км

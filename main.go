...
func (t Training) meanSpeed() float64 {
	// вставьте ваш код ниже
	return float64(t.distance() / float64(t.Duration*MinInHours))
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return (CaloriesWeightMultiplier*w.Weight + (math.Pow(w.meanSpeed(), 2.0)/w.Height*float64(CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * float64(w.Duration) * MinInHours
}

...
func (w Walking) Calories() float64 {
	squeredSpeed = math.Pow(w.meanSpeed()* KmHKmHInMsec,2)
	caloriesPerMinute = CaloriesWeightMultiplier*w.Weight + (squeredSpeed/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight
	return caloriesPerMinute * w.Duration.Hours() * MinInHours
}

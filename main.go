...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	speedMetersPerSecond := w.meanSpeed() / MinInHours * CmInM
	calories := (CaloriesWeightMultiplier*w.Weight + (math.Pow(speedMetersPerSecond, 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
	return calories
}

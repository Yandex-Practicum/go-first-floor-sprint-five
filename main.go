...
func (t Training) meanSpeed() float64 {
	...
	distance := t.distance()
	return distance / float64(t.Duration.Hours()) * MinInHours
}
...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (meanSpeedPow/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * float64(w.Duration.Hours()))
}

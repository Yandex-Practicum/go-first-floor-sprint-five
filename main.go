...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	squareMeanSpeedInMsec := math.Pow(w.meanSpeed()*KmHInMsec, 2)
	return ((CaloriesWeightMultiplier*w.Weight + (squareMeanSpeedInMsec/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
